...
/*
 * RISC-V ORC (Oops Rewind Capability) entry generation for objtool.
 *
 * Generates .orc_unwind and .orc_unwind_ip sections based on the CFI
 * state computed by objtool's instruction analysis pass.
 */
